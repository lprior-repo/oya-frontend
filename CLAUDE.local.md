...
**YOU ARE IN: `oya_frontend/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/oya_frontend/` (rig root) or other directories
...
**Your mail address:** `oya_frontend/polecats/rust`
**Your rig:** oya_frontend
**Your Witness:** `oya_frontend/witness`
...
| Ask Witness for help | `gt mail send oya_frontend/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`oya_frontend/witness`) when:
...
```bash
gt mail send oya_frontend/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
