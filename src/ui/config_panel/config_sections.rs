                    ...
                    input {
                        ...
                        oninput: move |e| {
                            if let Ok(value) = e.value().parse::<u64>() {
                                update_u64.call(("delay_ms".to_owned(), value));
                            }
                        }
                    }
                }
            ...
            WorkflowNode::Condition(_) | WorkflowNode::Switch(_) => rsx! {
                div { class: "flex flex-col gap-1.5",
                    ...
                    textarea {
                        ...
                        oninput: move |e| update_str.call(("expression".to_owned(), e.value()))
                    }
                }
            },
            ...
            WorkflowNode::Sleep(_) => rsx! {
                div { class: "flex flex-col gap-1.5",
                    ...
                    input {
                        ...
                        oninput: move |e| if let Ok(value) = e.value().parse::<u64>() { update_u64.call(("duration_ms".to_owned(), value)); }
                    }
                }
            },
            WorkflowNode::Timeout(_) => rsx! {
                div { class: "flex flex-col gap-1.5",
                    ...
                    input {
                        ...
                        oninput: move |e| if let Ok(value) = e.value().parse::<u64>() { update_u64.call(("timeout_ms".to_owned(), value)); }
                    }
                }
            },
            _ => rsx! {},
